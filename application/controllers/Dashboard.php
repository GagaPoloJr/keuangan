...
class Dashboard extends MY_Controller {
	...
	public function pemasukan2($id)
	{
		$this->load->database();
		$data['pemasukan'] = $this->db->query("select * from 1_pemasukan where id_proyek= '$id'")->result();
		$data['sub_pemasukan'] = $this->db->query("select * from 2_sub_pemasukan where id_proyek= '$id'")->result();
		$data['totalsub'] = $this->db->query("select nominal , sum(nominal) as sum from 2_sub_pemasukan where id_proyek= '$id'")->result();
	...
	public function tbl_proyek2($id){
		$this->load->database();
		$data['proyek1'] = $this->db->query("select * from 1_pemasukan where id_proyek= '$id'")->result();
		$data['proyek3'] = $this->db->query("select * from 4_proyek_keluar where id_proyek= '$id' limit 1")->result();
		$data['proyek2'] = $this->db->query("select * from 4_proyek_keluar where id_proyek= '$id'")->result();
		$data['totalpro'] = $this->db->query("select nominal , sum(nominal) as sum from 4_proyek_keluar where id_proyek= '$id'")->result();
		$data['totalsub'] = $this->db->query("select nominal , sum(nominal) as sum from 2_sub_pemasukan where id_proyek= '$id'")->result();
	...
	public function export_masuk2($id)
	{
		$this->load->library('epdf.php');
		$data['masuk'] = $this->db->query("select * from 1_pemasukan where id_proyek='$id'")->result();
		$data['sub_masuk'] = $this->db->query("select * from 2_sub_pemasukan where id_proyek='$id'")->result();
	...
	public function export_kproyek($id)
	{
		$this->load->library('epdf.php');
...
//////////////////////------------------------FORM------------------////////////////////////
	...
	public function new_submasuk($id)
	{
		$this->load->database();
		$data['pemasukan'] = $this->db->query("select * from 1_pemasukan where id_proyek= '$id'")->result();
		$data['sub_pemasukan'] = $this->db->query("select * from 2_sub_pemasukan where id_proyek= '$id'")->result();
	...
	public function new_proyek($id)
	{
		$this->load->database();
		$data['proyek'] = $this->db->query("select * from 1_pemasukan where id_proyek= '$id'")->result();
		$data['proyek_keluar'] = $this->db->query("select * from 4_proyek_keluar where id_proyek= '$id'")->result();
...
//INPUT PENGELUARAN KANTOR
	...
	public function delete_pemasukan1($id)
	{
		$where = array(
			'id_proyek' => $id
		);
	...
	public function delete_pemasukan2($id)
	{
		$where = array(
			'id_sub' => $id
		);
