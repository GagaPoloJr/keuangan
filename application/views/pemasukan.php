                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" id="heading-table">
                            ...
                            <a href="<?php echo base_url("dashboard/new_masuk") ?>"><button class="btn" id="button1"><i class="fa fa-plus"></i> Add Project</button></a>
                            <a href="<?php echo base_url("dashboard/export_masuk1") ?>"><button class="btn" id="export"><i class="fa fa-file-pdf-o"></i> Export to PDF</button></a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php foreach ($pemasukan as $pm) { ?>
                                                ...
                                                <td><a href="<?php echo base_url() . 'dashboard/pemasukan2/' . $pm->id_proyek ?>" type="button" class="btn btn-success">Pemasukan</a>
                                                    <a style="text-decoration: none" href="javascript:;" data-id="<?php echo $pm->id_proyek ?>" data-nama="<?php echo $pm->nama ?>" data-anggaran="<?php echo $anggaran ?>" data-toggle="modal" data-target="#edit-data">
                                                        <button data-toggle="modal" data-target="#ubah-data" class="btn btn-warning">Edit</button>
                                                    </a>
                                                    <a onclick="deleteConfirm('<?php echo base_url() . 'dashboard/delete_pemasukan1/' . $pm->id_proyek ?>')" href="#" type="button" class="btn btn-danger">Delete </a></td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php } ?>
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url('dashboard/ubah') ?>" method="post" enctype="multipart/form-data" role="form">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Tuliskan nama proyek">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-2 col-sm-2 control-label">Anggaran</label>
                                                        <div class="col-lg-10">
                                                            <input type="text" class="form-control" name="anggaran" id="anggaran" placeholder="Tuliskan jumlah anggaran">
                                                        </div>
                                                    </div>
                                                </div>
