                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php $k->sum;
                                $total =  $k->sum;
                                echo $total1 = "Rp " .  number_format($total, 0, ',', '.');
                                ?></td> ?></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <?php foreach ($masuk22 as $m2 => $key) { ?>
                            <td><?php echo $key->id_sub ?></td>
                            <td><?php echo $key->proyek; ?></td>
                            <td><?php $masuk = $key->sum;
                                echo   $masuk1 = "Rp " . number_format($masuk, 0, ',', '.');
                                ?></td>
                            <td><?php $keluar = $proyek2[$m2]->sum;
                                echo   $keluar1 = "Rp " . number_format($keluar, 0, ',', '.');
                                ?></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th id="totrek" style="text-align:left;" colspan="1">
                            ...
                            echo $profit = "Rp " . number_format($total, 0, ',', '.'); ?>
                        </th>
                    </tr>
                </tfoot>
            </table>
    ...
    <div class="container-fluid">
        <div class="col-lg-12" id="profitproyekrek1">
            ...
            <div id="hasil">
                ...
                echo $profit = "Rp " . number_format($comprof, 0, ',', '.'); ?>
